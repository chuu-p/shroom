...
audio forwarding is also working! the pi sits between the phone and headphones as a relay. audio from the phone is captured via pipewire's monitor source, forwarded over ssh to the pi, then sent via bluetooth to the headphones.

run audio.sh on the phone: 

~~~
./audio.sh
~~~

run connect_headphones.sh to connect to headphones
~~~
./connect_headphones.sh
~~~
